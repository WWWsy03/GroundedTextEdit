...
# 导入你刚创建的 Processor
from grounded_processor import GroundedQwenAttnProcessor
...
class MyGroundedQwenPipeline(DiffusionPipeline, QwenImageLoraLoaderMixin):
    ...
    def __init__(
        ...
        print("🔥 [MyGroundedPipeline] 开始热插拔 Attention Processors...")
    ...
    def __call__(
        ...
        img_shapes = [
            [
                ...
                (1, vae_image_sizes[0][1] // self.vae_scale_factor // 2, vae_image_sizes[0][0] // self.vae_scale_factor // 2), # Orig
                (1, vae_image_sizes[1][1] // self.vae_scale_factor // 2, vae_image_sizes[1][0] // self.vae_scale_factor // 2), # Control
            ]
        ] * batch_size
