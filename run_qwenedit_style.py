...
# 加载图像
content_image = Image.open("/app/code/TextEditor-v2/images/example1.jpg").convert("RGB")
...
# 生成图像
image = pipe(content_image, prompt, style_image=style_image, num_inference_steps=50).images[0]
