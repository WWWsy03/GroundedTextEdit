...
# 加载图像
content_image = Image.open("/app/cold1/code/texteditRoPE/train_data_dir/content_images/img4.jpg").convert("RGB")
style_image = Image.open("/app/cold1/code/texteditRoPE/train_data_dir/style_images/style4.jpg").convert("RGB")
prompt = "把文字\"jade\"的样式改成第二张图的样式,保持文字内容不变"
...
image.save("/app/cold1/code/texteditRoPE/qwenimage-style-rope-lora/test_results/test4_scale0_checkpoint2500.png")