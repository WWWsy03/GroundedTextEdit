...
lora_path = "/app/cold1/code/texteditRoPE/qwenimage-overall-test/checkpoint-700"
pipe.load_lora_weights(lora_path, weight_name="pytorch_lora_weights.safetensors")


checkpoint_path = "/app/cold1/code/texteditRoPE/qwenimage-overall-test/checkpoint-700/style_control_layers.safetensors"
...
# 加载图像
origin_image = Image.open("/app/cold1/code/texteditRoPE/textEditing-test-case/1_origin.png").convert("RGB").resize((768,1024))
content_image = Image.open("/app/cold1/code/texteditRoPE/textEditing-test-case/1_content.png").convert("RGB").resize((768,1024))
style_image = Image.open("/app/cold1/code/texteditRoPE/textEditing-test-case/1_style.png").convert("RGB").resize((768,1024))
mask_image = Image.open("/app/cold1/code/texteditRoPE/textEditing-test-case/1_mask.png").convert("RGB").resize((768,1024))
prompt = "修改图一中的文字，将图一中mask区域所对应的文字去掉，并按照图三文字布局参考图四文字风格在图一上绘制文字'Helloworld!'"
...
inputs = {
    ...
    # "height": 768,#暂时固定分辨率，不然噪声对于风格图的查询维度不匹配
    # "width": 1024,
    "true_cfg_scale": 4.0,
    "negative_prompt": " ",
...
image.save("/app/cold1/code/texteditRoPE/train_lora_kv_rope/overall-pipeline/test_results/test1_cp700_7681024.png")